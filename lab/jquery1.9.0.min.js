...
$.extend({
    getClearText:function(text,num){
        text = str.replace(/<.*?>/ig,"");
        return u.trim(text);
    },
    getTimeDown:function(d,h,m,s){
        if(d==undefined&&h==undefined&&m==undefined&&s==undefined){
            ...
            if(m==undefined) m=0;
            if(s==undefined) s=0;
            var rangeT=d*24*3600*1000+h*3600*1000+m*60*1000+s*1000,
                now = new Date(),
                date = new Date(now.getTime() - rangeT),
                year = date.getFullYear(),
                month = date.getMonth() + 1,
                day = date.getDate(),
                hour = date.getHours(),
    ...
    getTimeDay24:function(d,h,m,s){
        if(d==undefined&&h==undefined&&m==undefined&&s==undefined){
            ...
            if(m==undefined) m=0;
            if(s==undefined) s=0;
            var rangeT=(d+1)*24*3600*1000+h*3600*1000+m*60*1000+s*1000,
                now = new Date(),
                date = new Date(now.getTime() - rangeT),
                year = date.getFullYear(),
                month = date.getMonth() + 1,
